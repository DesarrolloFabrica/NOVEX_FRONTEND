...
export function EventsCenterSummary({ metrics }: EventsCenterSummaryProps) {
  return (
    ...
    >
      <div>
        <p className="novex-section-eyebrow mb-1">Resumen operacional</p>
      ...
      <div className="min-h-0 flex-1 space-y-6 overflow-y-auto pr-1">
        ...
        <div className="novex-exec-stat-grid">
          <div>
            <p className="novex-exec-stat__value">{metrics.averageRiskScore}</p>
            <p className="novex-exec-stat__label">Riesgo</p>
          </div>
          <div>
            <p className="novex-exec-stat__value">{metrics.criticalCount}</p>
            <p className="novex-exec-stat__label">Críticos</p>
          </div>
          <div>
            <p className="novex-exec-stat__value">{metrics.openCount}</p>
            <p className="novex-exec-stat__label">Abiertos</p>
          </div>
          <div>
            <p className="novex-exec-stat__value">{metrics.totalEvents}</p>
            <p className="novex-exec-stat__label">Total</p>
          </div>
        </div>

        {metrics.dominantAreaName ? (
          <div>
            <p className="novex-section-eyebrow">Dónde</p>
